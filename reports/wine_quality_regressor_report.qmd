...
![](../results/figures/wine_quality_3_coefficients.png){#fig-wine_quality_3_coefficients width="50%"}

![](../results/figures/wine_quality_4_coefficients.png){#fig-wine_quality_4_coefficients width="50%"}

![](../results/figures/wine_quality_5_coefficients.png){#fig-wine_quality_5_coefficients width="50%"}

![](../results/figures/wine_quality_6_coefficients.png){#fig-wine_quality_6_coefficients width="50%"}

![](../results/figures/wine_quality_7_coefficients.png){#fig-wine_quality_7_coefficients width="50%"}

![](../results/figures/wine_quality_8_coefficients.png){#fig-wine_quality_8_coefficients width="50%"}

![](../results/figures/wine_quality_9_coefficients.png){#fig-wine_quality_9_coefficients width="50%"}
